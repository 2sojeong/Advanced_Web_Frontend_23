...
const Component2 = () => {
    return (
        <>
            <div style={{ maxWidth: '100%', width: '100%', position: 'relative', margin: '0 auto', border: '0', display: 'block' }} class="Home_career-banner">
                ...
                <div style={{ position: 'absolute', padding: '0 200px', top: 'calc(50% - 80px)', color: '#ffffff' }} class="Home_career-banner__text">
                    <div style={{ fontSize: '30px', fontWeight: '700' }} class="Home_career-banner__title">채용</div>
                    <div style={{ fontSize: '35px', fontWeight: '700' }} class="Home_career-banner__description highContrastTarget">
                        함께 지식을 쌓고<br />
                        성장합니다.
                    </div>

                    <div class="Home_career-banner__item-btn-wrap">
                        <a style={{ backgroundColor: '#ffffff', color: '#000000' }} href="/kr/careers/" class="Home_career-banner__item-btn dark-bg btn-large highContrastTarget" data-an-tr="body contents" data-an-ca="link click" data-an-ac="더 알아보기" data-an-la="career banner">더 알아보기</a>
                    </div>
                </div>
            </div>
