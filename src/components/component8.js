const Component8=()=>{
    return(
        ...
        <div style={{marginTop:"30px"}}>
            ...
            <span style={{width:"37px",height:"2px",background:"#000",marginTop:"20px",marginRight:"auto",marginLeft:"auto",
            marginBottom:"10px",display:"block",content:''}}></span>
            ...
            <div className="thmb_list02" style={{width:"100%",paddingTop:"30px",width:"1280px",display:"table",marginRight:"auto",marginLeft:"auto",position:"relative",marginBottom:"20px"}}>
                <div className="list_area" style={{width:"100%",display:"table"}}>
                    <div className="item_big" style={{float:"left",width:"620px",marginRight:"40px",
                    ...
                    <div className="item" style={{float:"left",width:"300px",minHeight:"300px",marginRight:"20px",verticalAlign:"top",
                        ...
                        <div className="item" style={{float:"left",width:"300px",minHeight:"300px",verticalAlign:"top",
                            paddingTop:"15px",paddingBottom:"15px"}}>
                        <div className="thmb" style={{width:"100%",position:"relative"}}>
