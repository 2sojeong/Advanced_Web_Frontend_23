...
const MarketPage = () =>
    <>
        ...
        <Component4 color="#0082FF" head='카카오i클라우드' title='기업용 통합 클라우드 플랫폼' content1='다양한 기술, 플랫폼, 서비스를 안정적으로 연결하여 신뢰할 수 있는 클라우드입니다.
        ...
        <Component5 head='Manifesto' content1='우리는 꿈을 현실로 만드는 여정에 함께하는 동반자들이다.' content2='우리는 사람들이 자신의 꿈을 실현하는 것을 도움으로써' content3='더 나은 세상을 만드는데 기여한다.' content4='기술과 서비스,' content5='그리고 혁신적인 아이디어로 우리 모두의 꿈을 현실로 만듭니다.' img='https://kakaoenterprise.com/wp-content/themes/kakaoenterprise/images/sub/info/about-intro-poster.jpg?v1.1' />
        ...
        />
        <Component10 head='한 ' contents={['프리', 'c 생산성을 한 차원 높여주세요.']} />
