...
const InfoPage2 = () => {
        return <>
                ...
                <Component2 reverse={true} head='BIO' contents={[' Biotechnology', 'Innovation Organization']} url="https://www.bio.org/" imgurl={img} />
                <Component5 id='section1' paddingRight='150px' head='What is Biotechnology?' content1='Biotechnology is technology based on biology.' content2='Using Biology to develop new products, methods and organisms' content3='intended to improve human health and society.' content4='Modern biotechnology provides' content5='breakthrough products and technologies.' img={info1} />
                <br />
                <Component10 id='section2' head='Heal the World' marginLeft='350px' contents={["harnessing nature's own toolbox and using our own", 'genetic makeup to heal and guide lines of research by', '\n', "-Reducing rates of infectious disease", "-Saving millions of children's lives", "-Creating more precise tools for disease detection"]} img={info2} />
                <Component10 reverse={true} head='Feul the World' marginRight='300px' contents={['uses biological processes such as fermentation and harnesses biocatalysts to become', "microscopic manufacturing plants by", '\n', "-Streamlining in chemical manufacturing processes", "-Reducing use of and reliance on petrochemicals"]} img={info3} />
                <Component10 head='Feed the World' marginLeft='350px' contents={["improves crop insect resistance, enhances", 'crop herbicide tolerance and facilitates the use of more', ' environmentally sustainable farming practices by', '\n', "-Generating higher crop yields with fewer inputs", "-Lowering volumes of agricultural chemicals"]} img={info4} />
                <div style={{ margin: "150px auto" }}></div>
                <Component4 id='section3' color='#22a140' head='Biotech company' title='BioNTech SE' content1='We aspire to translate science into survival by developing new immunotherapies. We are committed to improving the health of people worldwide with our fundamental research and our work in the area of development of immunotherapies utilizing the full potential of the immune system to fight cancer, infectious diseases and other serious diseases.' content2='Learn more' link="https://www.biontech.com/int/en/home.html" image1={original} />
