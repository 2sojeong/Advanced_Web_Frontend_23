...
const InfoPage2 = () => {
        return <>
                ...
                <Component10 reverse={true} head='Feul the World' marginRight='180px' contents={['uses biological processes such as fermentation and harnesses biocatalysts to become', "microscopic manufacturing plants by", '\n', "-Streamlining in chemical manufacturing processes", "-Reducing use of and reliance on petrochemicals"]} img="https://www.ukri.org/wp-content/uploads/2021/04/BBSRC-080421-GettyImages-169999232-735x492.jpg" />
