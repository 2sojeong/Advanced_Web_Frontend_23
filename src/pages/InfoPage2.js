...
const InfoPage2 = () => {
        return <>
                ...
                <br />
                <Component10 id='section2' head='Heal the World' contents={["harnessing nature's own toolbox and using our own", 'genetic makeup to heal and guide lines of research by', '\n', "-Reducing rates of infectious disease", "-Saving millions of children's lives", "-Creating more precise tools for disease detection"]} img={info2} />
