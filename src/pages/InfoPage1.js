...
const InfoPage1 = () => {
        return <>
                ...
                <Component8 id='section3' bgColor="#B8DFF8" title1='Major Medicines' title2='Experience a definite effect with the major medicine suggested by SoonYeol BIO' data={[Com8data1, Com8data2, Com8data3, Com8data4, Com8data5, Com8data6]} />
                <br /><br /><br />
